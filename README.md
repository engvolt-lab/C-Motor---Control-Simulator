...
flowchart TD
    ...
    classDef control fill:#0f172a,stroke:#38bdf8,stroke-width:2px,color:#f8fafc;
    classDef plant fill:#0f172a,stroke:#34d399,stroke-width:2px,color:#f8fafc;
    classDef sensor fill:#0f172a,stroke:#c084fc,stroke-width:2px,color:#f8fafc;
    classDef safety fill:#1f1315,stroke:#f87171,stroke-width:2px,color:#f8fafc;
    classDef output fill:#1e293b,stroke:#fbbf24,stroke-width:2px,color:#f8fafc;

    OP["<b>Operator Inputs</b><br/>• Target RPM: 0 to 3000<br/>• Load Torque: 0.01 to 0.25 Nm<br/>• Fault Injections / E-Stop"]:::input
    ...
    subgraph MC ["<b>MotorController (Real-Time Orchestrator — dt = 10 ms)</b>"]
        ...
        subgraph SetpointShaping ["Setpoint Conditioning"]
            ...
            SUM(("<b>Σ</b><br/>Error<br/><i>e = r - y</i>")):::control
        end

        subgraph ControlCore ["Regulation & Power Interlock"]
            PID["<b>PIDController</b><br/>• P: Kp · e(k)<br/>• I: Ki ∫e dt (Clamp ±200)<br/>• D: Kd · Δe/Δt<br/>• Clamp: 0 to 48 V"]:::control
            GATE{"<b>Safety Interlock</b><br/>Normal: Pass V_cmd<br/>Tripped: Cut to 0 V"}:::safety
        end

        subgraph PlantDynamics ["<b>DC Motor Physics (Plant)</b>"]
            ELEC["<b>Electrical Subsystem</b><br/>Back-EMF: V_back = Ke · ω<br/>Current: I = (V_in - V_back) / R"]:::plant
        ...
        subgraph FeedbackPath ["Feedback Loop"]
            ENC["<b>Incremental Encoder</b><br/>• Resolution: 1024 PPR<br/>• Noise: ±0.5 RPM<br/>• Signal Loss Detect"]:::sensor
        end
    ...
    SAFE ==>|"Trip: LATCH &amp; CUT POWER"| GATE

    %% Real-time telemetry sink
    MC ==>|"Telemetry Stream"| OUT
```
